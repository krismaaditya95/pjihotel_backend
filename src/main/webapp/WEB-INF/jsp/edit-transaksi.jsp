...
<div class="w3-container" style="margin-left: 200px">
	<div class="div-title">
		<h3>Edit Check-In / Booking data</h3>
	</div>
	...
	<form class="formtambaheditTrx w3-card-4 w3-light-grey w3-text-grey w3-margin" method="post">
		...
		<div class="form-row">
			<div class="form-group col-md-6">
				...
				<div class="form-line">
					<input name="check_in_date" type="date" class="form-control" value="${transaksiedit.checkInDate}">
				</div>
			</div>
			...
			<div class="form-group col-md-6">
				...
				<div class="form-line">
					<input name="check_in_time" type="time" class="form-control" value="${transaksiedit.checkInTime}">
				</div>
			</div>
		</div>
		...
		<div class="form-row">
			<div class="form-group col-md-6">
				...
				<div class="form-line">
					<input name="check_out_date" type="date" class="form-control" value="${transaksiedit.checkOutDate}">
				</div>
			</div>
			...
			<div class="form-group col-md-6">
				...
				<div class="form-line">
					<input name="check_out_time" type="time" class="form-control" value="${transaksiedit.checkOutTime}">
				</div>
			</div>
		</div>

		<div class="col-sm-7">
			<label class="form-label">Kamar</label> <select class="w3-select"
				name="idStatusCheck">
		...
		<%-- <div class="col-sm-7">
			<div class="form-group form-float">
				...
				<div class="form-line">
					<input name="totalHarga" type="number" class="form-control" value ="">
				</div>
			</div>
		</div> --%>
